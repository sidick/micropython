...
Companion to `ports/amiga/tools/amiga-fdgen.py` and `ports/amiga/tools/amiga-taggen.py`: where those
...
Run without arguments for the default behaviour (writes to stdout):
    ...
    ports/amiga/tools/amiga-structgen.py -o ports/amiga/modules/_amiga_structs.py
...
the same Docker wrapper used for the build, e.g.:
    ...
    docker run --rm -v "$PWD:/work" -w /work bebbo/amiga-build \\
        python3 ports/amiga/tools/amiga-structgen.py \\
...
def emit_python(specs, values, out, headers):
    ...
    """
    out.write("# Auto-generated by ports/amiga/tools/amiga-structgen.py -- do not edit.\n")
