...
Companion to `ports/amiga/tools/amiga-fdgen.py`: where that tool derives library
...
Run without arguments for the default behaviour:
    ...
    ports/amiga/tools/amiga-taggen.py -o ports/amiga/modules/_amiga_tags.py
"""
...
def emit_python(values, out, headers):
    ...
    out.write("# Auto-generated by ports/amiga/tools/amiga-taggen.py — do not edit.\n")
